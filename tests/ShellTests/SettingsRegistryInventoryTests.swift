...
final class SettingsRegistryInventoryTests: XCTestCase {
    ...
    static let expected: [Setting] = [
        ...
        Setting("clockFormat", configKey: "clock-format", policy: .synced),
        ...
        Setting("customLocale", configKey: "custom-locale", policy: .synced),
        ...
        Setting("localeMode", configKey: "locale-mode", policy: .synced),
        ...
        Setting("profilesSortOrder", configKey: "profiles-sort-order", policy: .synced),
        ...
        Setting("swipeGestureBindings", configKey: nil, policy: .synced),
        ...
        Setting("themeUIOverrides.v1", configKey: nil, policy: .synced),
        ...
        Setting("windowPaddingXOverride", configKey: "window-padding-x", policy: .localByDefault),
        Setting("windowPaddingYOverride", configKey: "window-padding-y", policy: .localByDefault),
    ]
