...
enum SSHConnectionHelper {
    private nonisolated static let logger = Logger(subsystem: "dev.chr33s.shell", category: "SSHConnectionHelper")
    ...
    /// Always send a signed publickey request. The probe-first mode existed
    /// for OpenSSH-compatibility debugging and is not exposed in this fork.
