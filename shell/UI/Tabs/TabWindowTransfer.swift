...
extension Notification.Name {
    static let tabTransferEmptiedWindow = Notification.Name("dev.chr33s.shell.tabTransferEmptiedWindow")
    static let tabTransferDragStateChanged = Notification.Name("dev.chr33s.shell.tabTransferDragStateChanged")
}
...
final class TabTransferCoordinator {
    ...
    private func closeEmptiedSourceWindow(_ sourceWindowId: String) {
        guard let sceneSessionId = TerminalWindowRegistry.sceneSessionId(for: sourceWindowId),
