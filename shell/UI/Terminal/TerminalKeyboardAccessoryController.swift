...
final class TerminalKeyboardAccessoryController: NSObject {
    ...
    private var visibleReportedKeyboardFrame: CGRect? {
        ...
        return nil
        #else
        let keyboardFrame = KeyboardGeometryMonitor.shared.keyboardFrame
    ...
    /// tall enough to pass KeyboardGeometryMonitor's docked-software-keyboard heuristic,
    ...
    private var bottomSafeAreaStripHeight: CGFloat {
        ...
        let keyboardGeometry = KeyboardGeometryMonitor.shared
        ...
        if toolbarOnlyMode {
            ...
            // keyboard attachment.
            accessoryRestsAtScreenEdge = !keyboardGeometry.isKeyboardDocked
        } else {
    ...
    private func updateBottomEdgeHomeGestureProtection(accessoryIsVisible: Bool? = nil) {
        ...
        // passes KeyboardGeometryMonitor's 100pt docked-keyboard heuristic, which would
