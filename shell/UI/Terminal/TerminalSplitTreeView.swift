...
struct TerminalSplitTreeView: UIViewRepresentable {
    ...
    func updateUIView(_ uiView: SplitTreeHostingView, context: Context) {
        ...
        uiView.highlightColor = uiView.tintColor ?? UIColor.appAccent
...
final class SplitTreeHostingView: UIView {
    ...
    var highlightColor: UIColor = .appAccent {
        didSet {
...
extension Notification.Name {
    /// Posted when a terminal's restoration state changes. Drives SwiftUI
    ...
    static let nextTab = Notification.Name("dev.chr33s.shell.nextTab")
    static let appTabSwipeBegan = Notification.Name("dev.chr33s.shell.appTabSwipeBegan")
    static let appTabSwipeChanged = Notification.Name("dev.chr33s.shell.appTabSwipeChanged")
    static let appTabSwipeEnded = Notification.Name("dev.chr33s.shell.appTabSwipeEnded")
    static let selectTab = Notification.Name("dev.chr33s.shell.selectTab")
    static let increaseFontSize = Notification.Name("dev.chr33s.shell.increaseFontSize")
    static let decreaseFontSize = Notification.Name("dev.chr33s.shell.decreaseFontSize")
    static let resetFontSize = Notification.Name("dev.chr33s.shell.resetFontSize")
    static let startSearch = Notification.Name("dev.chr33s.shell.startSearch")
    static let openSettings = Notification.Name("dev.chr33s.shell.openSettings")
    static let duplicateTabWithSSH = Notification.Name("dev.chr33s.shell.duplicateTabWithSSH")
