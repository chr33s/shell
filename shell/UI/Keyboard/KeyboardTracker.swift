...
class KeyboardTracker {
    ...
    @objc private func keyboardWillChangeFrame(_ notification: Notification) {
        ...
        guard overlayKeyboardPreservationOwnerWindowIsActive else {
            ...
            // returning matters because KeyboardGeometryMonitor gates on the latch when
...
extension Notification.Name {
    ...
    static let overlayKeyboardPreservationEnded = Notification.Name("dev.chr33s.shell.overlayKeyboardPreservationEnded")
}
